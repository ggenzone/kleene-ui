...
export function Sidenav({
  ...
  const safePosition = position ? position : 'left'
  ...
  return (
    <aside
      className={`${style.position[safePosition].default} ${
        open ? style.position[safePosition].open : style.position[safePosition].close
      }`}
      ref={ref}
    >
